  ...
  return (
    <section className="bg-linear-to-b from-white to-greyColor px-8 md:py-10 md:px-18 relative">
      <div className="flex flex-col items-center justify-center  md:mt-2">
        <p className="font-instrument-serif text-2xl italic leading-0 text-center font-normal capitalize pt-8 mb-8 text-[#545454] md:mx-2 md:text-[40px]">
          Save time, save Energy
        </p>
        <h1 className="font-lato text-4xl text-[#000000]  text-center w-[312px] font-extrabold leading-10 mb-4 md:w-6xl md:mb-4 md:text-[64px] md:leading-[100%]">
          Always your help in need
        </h1>
        <p className="w-[324px] text-center  font-lato text-lg leading-6 text-[#545454] md:w-xl md:text-[28px] md:-tracking-normal md:leading-[100%]">
