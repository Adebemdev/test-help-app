...
export default function Header() {
  return (
    <header className="md:px-8 md:py-5 fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
      {/* <div className="flex justify-between items-center h-16 max-w-7xl mx-auto  py-4"> */}
